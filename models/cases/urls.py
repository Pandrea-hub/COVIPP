...
urlpatterns = [
    ...
    url(r'^case/(?P<case_id>.+)/casebyperson/(?P<person_id>.+)/person/$', CaseByPerson.as_view(), name='casebyperson'),
    url(r'^person/(?P<person_id>.+)/cases/(?P<case_id>.+)/', CasesByPerson.as_view(), name='casesbyperson'),
