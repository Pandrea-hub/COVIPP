...
from models.cases.views import CasesList, CasesDetail, CasesByContagionType,CasesByPerson,CasesBySymptom,CasesByContagion,CasesByPersonAndCase
...
urlpatterns = [
    ...
    url(r'^person/(?P<person_id>.+)/casesbypersonandcase/(?P<case_id>.+)/$', CasesByPersonAndCase.as_view(), name='casesbypersonandview')
